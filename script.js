...
const apiKey = 'e481681fadf358731df2de659e7973fd';
...
function getCurrentDate() {
    ...
    return currentDate.toLocaleDateString('en-GB', options); //'en-GB' to get the date in the format of 'Wed, 01 Dec'
...
async function updateWeatherInfo(city) {
    ...
    tempTxt.textContent = temp + ' ℃'; //Math.round(temp) + ' ℃';
